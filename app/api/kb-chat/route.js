...
export async function POST(request) {
  try {
    ...
    if (kbResults.length > 0 && hasRelevantInfo) {
      ...
      const systemPrompt = config?.systemPrompt || `You are HelpBot, a specialized helpdesk AI assistant that ONLY provides information directly from the company knowledge base.
